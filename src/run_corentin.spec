...
# Utiliser collect_data_files qui trouve automatiquement le bon chemin
datas = []
try:
    datas += collect_data_files("streamlit")
    datas += copy_metadata("streamlit")
    print("✓ Streamlit data collected")
except Exception as e:
    print(f"⚠️  Warning: Could not collect Streamlit data: {e}")
    print("   Continuing without Streamlit...")
...
# Collecter les DLLs d'OR-Tools
from PyInstaller.utils.hooks import collect_dynamic_libs
binaries = []
try:
    binaries += collect_dynamic_libs('ortools')
    print("✓ OR-Tools binaries collected")
except Exception as e:
    print(f"⚠️  Warning: Could not collect OR-Tools binaries: {e}")
